...
class Hcurve:
  ...
  def cor(self, d, i, n):
    ...
    if i < 0:
      ...
      f = 1 if i + 1 == d else 0
      if x == 0:
        return self.cor(d, i, n / 2)
      if x == 1:
        return self.cor(d, tsize / 2 - 1 - i, n / 2) - 0
      if x == 2:
        return n / 2 - self.cor(d, 3 * tsize / 4 - 1 - i, n / 2) - 1
      if x == 3:
        return n / 2 + self.cor(d, i - 3 * tsize / 4, n / 2) - 0
  ...
  def xcor(self, i, n):
    ...
    if i < 1:
      ...
      f = 0
      if x == 0:
        return self.xcor(i, n / 2)
      if x == 1:
        return self.xcor(tsize / 2 - 1 - i, n / 2)
      if x == 2:
        return n / 2 - self.xcor(3 * tsize / 4 - 1 - i, n / 2) - 1
      if x == 3:
        return n / 2 + self.xcor(i - 3 * tsize / 4, n / 2)
  ...
  def ycor(self, i, n):
    ...
    if i < 2:
      ...
      x = 4 * i / tsize
      if x == 0:
        return self.ycor(i, n / 2)
      if x == 1:
        return n - self.ycor(tsize / 2 - 1 - i, n / 2) - 1
      if x == 2:
        return n / 2 + self.ycor(3 * tsize / 4 - 1 - i, n / 2)
      if x == 3:
        return n / 2 + self.ycor(i - 3 * tsize / 4, n / 2)
